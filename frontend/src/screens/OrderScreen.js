...
const OrderScreen = ({ match, history }) => {
    ...
    // success as now successPay giving alias name
    ...
    useEffect(() => {
        ...
        if (!order || order._id !== orderId || successPay || successDeliver) {
            dispatch({ type: actionTypes.ORDER_PAY_RESET }); // otherwise it will loop paypal 
    ...
    console.log(`Admin :${userInfo.isAdmin}, isPaid :${order.isPaid},  isDelivered: ${!order.isDelivered}`)
    return loading
        ? <Loader />
        : error
